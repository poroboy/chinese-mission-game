...
**Production:** https://chinese-mission-game.web.app
...
- เลือกเสียงจีนที่ติดตั้งในเครื่อง ปรับความเร็ว และทดลองฟังได้จากหน้า Settings
...
ถ้ามี Firebase config อยู่แล้วแต่ต้องการทดสอบโดยไม่ login ใช้ `npm run dev:demo`
